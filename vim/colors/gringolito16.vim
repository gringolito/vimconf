...
set background=dark
set t_Co=16
let g:colors_name="gringolito16"
...
" COLOR DEFINITIONS
""""""""""""""""""""""""
hi Blue             cterm=none             ctermfg=14           ctermbg=none
hi BlueU            cterm=underline        ctermfg=14           ctermbg=none
hi Green            cterm=none             ctermfg=2            ctermbg=none
hi Grey             cterm=none             ctermfg=7            ctermbg=none
hi Grey2            cterm=none             ctermfg=8            ctermbg=none
hi GreyR            cterm=none             ctermfg=none         ctermbg=7
hi DarkGreyR        cterm=none             ctermfg=none         ctermbg=7
hi LightGrey        cterm=none             ctermfg=7            ctermbg=none
hi Orange           cterm=none             ctermfg=208          ctermbg=none
hi Purple           cterm=none             ctermfg=12           ctermbg=none
hi Purple2          cterm=none             ctermfg=5            ctermbg=none
hi Red              cterm=none             ctermfg=1            ctermbg=none
hi RedR             cterm=none             ctermfg=none         ctermbg=9
hi Pink             cterm=none             ctermfg=13           ctermbg=none
hi White            cterm=none             ctermfg=15           ctermbg=none
hi Yellow           cterm=none             ctermfg=11           ctermbg=none
hi YellowR          cterm=none             ctermfg=none         ctermbg=11
...
hi! MatchParen          cterm=bold,italic       ctermfg=14      ctermbg=none
...
hi! DiffChange          cterm=none              ctermfg=bg      ctermbg=11
hi! DiffDelete          cterm=bold              ctermfg=bg      ctermbg=9
hi! DiffText            cterm=bold              ctermfg=bg      ctermbg=7
...
hi! FoldColumn          cterm=none              ctermfg=8       ctermbg=7
