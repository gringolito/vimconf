...
" Vim syntax highlighting for googletest
Plug 'evedovelli/googletest-syntax'
...
augroup c_cpp
    ...
    " Generate or update tags base
    autocmd FileType c,cpp,h map <F1> :!/usr/local/bin/generate-tags c<CR>:cs reset<CR>:TlistUpdate<CR>
    ...
    autocmd FileType c,cpp,h map <C-M-k> :%pyf /usr/share/vim/addons/syntax/clang-format-7.py<CR>
    autocmd FileType c,cpp,h imap <C-M-k> <c-o>:%pyf /usr/share/vim/addons/syntax/clang-format-7.py<CR>
...
function! FormatClangStyleNew()
    %pyf /usr/share/vim/addons/syntax/clang-format-7.py
endfunction
...
augroup go
    ...
    " Generate or update tags base
    autocmd FileType go map <F1> :!/usr/local/bin/generate-tags go<CR>:cs reset<CR>:TlistUpdate<CR>
augroup END
...
augroup python
    ...
    " Prefer ctags for python, instead cscope
    autocmd FileType python set nocscopetag
    " Generate or update tags base
    autocmd FileType python map <F1> :!/usr/local/bin/generate-tags python<CR>:cs reset<CR>:TlistUpdate<CR>
augroup END
...
"
augroup yang
    autocmd FileType yang set tabstop=4 softtabstop=4 shiftwidth=4 expandtab
augroup END
